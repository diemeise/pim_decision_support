...
const rules = [
  ...
  },
  {
    ...
    "condition": "questionnaire.ths_batterie_aelter_drei_Monate === true || \"entzugssymptome\" in questionnaire.parkinson_symptome_aktuell_symptome || questionnaire.schrittmacher_erschoepft === true",
